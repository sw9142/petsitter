    ...
    <html>
      <head>
        ...
        <style>
          ...
          .admin_matching .search_bar {
            padding: 1rem;
          }

          .admin_matching .search_bar span {
            color: #423bad;
            font-weight: bold;
            padding: 0.8rem;
          }
          .admin_matching table {
            text-align: center;
            max-width: 1000px;
          }
          .admin_matching .table thead th {
      ...
      <body>
        ...
        <div class="admin_matching">
          <h1 align="center" style="font-weight: bold">매칭내역 관리</h1>
          <br />

          <div align="center" class="search_bar">
            <form
              action="<%= contextPath %>/matchsearch.ad?currentPage=1"
              method="post"
          ...
          <script>
            $(function () {
              $(".list-area>tbody>tr").click(function () {
                ...
                location.href =
                  "<%= contextPath %>/adminMatchDetail.ad?mno=" + mno;
              });
            });
          </script>
          ...
          >
            ...
            <% if(currentPage != 1) { %>
            <button
              onclick="location.href='<%= contextPath %>/adminMatch.ad?currentPage=<%= currentPage - 1 %>'"
            >
              &lt;
            </button>
            <% } %>
            ...
            <% if(i != currentPage) { %>
            <button
              onclick="location.href='<%= contextPath %>/adminMatch.ad?currentPage=<%= i %>'"
            >
              <%= i %>
            </button>
            <% } else { %>
