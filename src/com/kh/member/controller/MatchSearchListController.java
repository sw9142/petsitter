...
/**
 * Servlet implementation class MatchSearchList
 */
@WebServlet("/matchsearch.ma")
public class MatchSearchListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MatchSearchListController() {
        super();
	...
	//------------------------------페이징 처리--------------------------------------------------------------------
				...
				// * listCount : 총 게시글 갯수
				listCount = new MatchService().MatchSearchListCount(location, maStartDate, maEndDate,id ,loginUser);
				...
				ArrayList<Match> list = new MatchService().matchSearchList(pi,id ,location, maStartDate, maEndDate, loginUser);
				...
				request.getRequestDispatcher("views/member/matchSearchList.jsp").forward(request, response);
